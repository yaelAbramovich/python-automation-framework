...
from src.utils.word_counter import (
    ...
    get_word_occurrence_counts,
    print_word_occurrence_counts,
)
...
def test_unique_word_count_matches_between_ui_and_api(
    ...
    print_word_occurrence_counts("UI", ui_word_occurrence_counts)
    ui_unique_word_count = get_unique_word_count(ui_word_occurrence_counts)
    print(f"UI unique word count: {ui_unique_word_count}")
    print("-" * 40)
    ...
    print_word_occurrence_counts("API", api_word_occurrence_counts)
    api_unique_word_count = get_unique_word_count(api_word_occurrence_counts)
    print(f"API unique word count: {api_unique_word_count}")
