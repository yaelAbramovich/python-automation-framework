...
class _ExampleLoginPage(BasePage):
    ...
    def __init__(self, page: Page) -> None:
        ...
        self._submit_button = page.get_by_role("button", name="Login").describe("Login submit button")
    ...
    def assert_flash_message_contains(self, expected_fragment: str) -> None:
        ...
        self._assert_element_is_visible(flash_locator, f'Flash message containing "{expected_fragment}"')
...
def test_login_with_valid_credentials_shows_success_message(page: Page) -> None:
    ...
    login_page.open()
    login_page.login_with(environment_configuration.ui_username, environment_configuration.ui_password)
